...
- **多语言界面**（8 种：简体中文 / 繁體中文 / English / Français / Deutsch / 日本語 / 한국어 / العربية）：主界面与暂停菜单的地球小按钮打开语言切换界面，即选即存；全部界面文本与方块/物品/怪物名称均已本地化（阿语暂为 LTR 布局）
...
│   ├── i18n/            # 本地化（t 翻译核心、8 语言包、方块/物品/怪物名称八语字典）
...
- 界面支持 8 种语言（简中/繁中/英/法/德/日/韩/阿），即选即存；**阿拉伯语暂为 LTR 布局**（仅文本本地化，不做 RTL 镜像）。
